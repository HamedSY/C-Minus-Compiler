...
# as you see below, based on the agenda we make differnt desicions. details can be found on page 16th of the lecture note 5
        ...
        if top_symbol in cls:
            ...
            if top_symbol == lookahead:
                ...
                lookahead, top_symbol, top_node , token_type, lexeme, agenda  = panic_mode_recovery(stack, lookahead, line_number, top_symbol,top_node,token_type, lexeme)
                flag=1
                continue
        ...
        #  No valid production
            ...
            lookahead, top_symbol, top_node , token_type, lexeme, agenda  = panic_mode_recovery(stack, lookahead, line_number)
            flag=1
            continue
